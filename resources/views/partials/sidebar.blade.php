        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="group">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ URL::tokenRoute('shop.index') }}">All Group</a></li>
                    {{-- <li class="nav-item"> <a class="nav-link" href="{{ URL::tokenRoute('t') }}">Create</a></li> --}}
                </ul>
            </div>
        </li>
        <li class="nav-item"> <a class="nav-link" href="{{ URL::tokenRoute('shop.index') }}">Shop</a></li>
        <li class="nav-item">
